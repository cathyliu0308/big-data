...
public class LanguageModel {
	public static class Map extends Mapper<LongWritable, Text, Text, Text> {
		...
		public void map(LongWritable key, Text value, Context context) throws IOException, InterruptedException {
			...
			//this is cool\t20 (the input is the output from lasr step)
			//split between n-1 and n
			//value = nth word + count

			String line = value.toString().trim();
			String[] words_count = line.split(regex:"\t");
			...
			//index0 = this is cool
			//index1 = 20
			String[] words = words_count[0].split(regex:"\\s+");
			...
			stringoutputValue = words[words.length - 1] + "=" + count;
	...
	public static class Reduce extends Reducer<Text, Text, DBOutputWritable, NullWritable> {
		...
		public void reduce(Text key, Iterable<Text> values, Context context) throws IOException, InterruptedException {
			...
			//treeMap<count, list<word>> -> {<1000, <shit, beautiful,...>, <500, <girl, women,...>}
